...
void CControlUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
    ...
    else if( _tcscmp(pstrName, _T("heightpercent")) == 0 ) SetYPercent(_ttoi(pstrValue));
    else if( _tcscmp(pstrName, _T("widthpercent")) == 0 ) SetXPercent(_ttoi(pstrValue));
...
int CControlUI::GetYPercent() const
{
    return m_cPercent.cy;
}

int CControlUI::GetXPercent() const
{
    return m_cPercent.cx;
}

void CControlUI::SetYPercent( int yp )
{
    m_cPercent.cy = yp;
}

void CControlUI::SetXPercent( int xp )
{
    m_cPercent.cx = xp;
}
